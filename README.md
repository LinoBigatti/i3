...
If you're running an Arch-based distro, you can install the original fork from the AUR (`i3-gaps-rounded`).
...
*Note:* When cloning the repo, replace `Airblader/i3` with `linobigatti/i3-radius`.
